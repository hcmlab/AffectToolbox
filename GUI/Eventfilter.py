...
def moveLinesFrom3to4to5(window):
    ...
    window.hlineWidgetVoicetoPara.setFixedSize(hlineWidget_length + window.LINEWIDTH, window.LINEWIDTH)
    ...
    window.hlineWidgetFacetoFacial.setFixedSize(hlineWidget_length +1, window.LINEWIDTH)
    ...
    window.hlineWidgetSkeltoBody.setFixedSize(hlineWidgetSkeltoBody_length, window.LINEWIDTH)
    ...
    window.hlineWidgetBodytoPose.setFixedSize(hlineWidgetBodytoPose_length, window.LINEWIDTH)
